...
import { FaArrowDown, FaArrowRight, FaEnvelope } from "react-icons/fa";
              ...
              <div className="collapse w-full">
                ...
                <div className="collapse-title text-xl font-medium flex justify-between w-full">
                  <div className="flex gap-3">
                    <div className="items-center">2 x</div>
                    <div className="items-center">Chicken KFC</div>
                  </div>
                  <div className="flex">
                  <div className="items-center">50.00$</div>      
                  </div>
                </div>
                <div className="collapse-content">
                  <img
                    src="https://theartisticcook.com/wp-content/uploads/2023/06/kfc-1.jpg"
                    className="w-[200px]"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                <div className="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                  ...
                  <p className="w-48 lg:w-full xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">
                    180 North King Street, Northampton MA 1060
                  </p>
                </div>
              </div>
            </div>
